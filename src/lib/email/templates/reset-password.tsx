...
const ResetPasswordEmail = ({ url }: ResetPasswordEmailProps) => {
  return (
    ...
    >
      <Html>
        <Head />
        <Body className="bg-gray-100 py-3 font-sans text-base font-normal">
          <Preview>Subtracker reset your password</Preview>
          <Container className="border bg-white p-12">
            <Text className="text-xl font-medium">Subtracker</Text>
            <Section>
              <Text>Hi,</Text>
              <Text>
                Someone recently requested a password change for your Subtracker account. If this
