        ...
        <PopoverTrigger
          render={
            <Button
              ...
              variant="ghost"
              disabled={
                usersQuery.isLoading || paymentMethodsQuery.isLoading || categoriesQuery.isLoading
              }
            >
              <FilterIcon
                className={cn(hasActiveFilters ? "fill-primary text-primary" : "text-foreground")}
              />
            </Button>
          }
        />
            ...
            {filtersDisplayed.includes("schedule") && (
              <>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFilters({
                      schedule: filters.schedule === value ? null : (value as Schedule),
                    })
                  }
              ...
              <>
                ...
                >
                  <SelectTrigger className="w-full">
                    <SelectValue>
                      {renderMultiselectValue(paymentMethods, filters.paymentMethods)}
                    </SelectValue>
                  </SelectTrigger>
                  <SelectContent>
